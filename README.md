...
- атаки и защита;
- смерть, resurrection и полноценные DWT faces/effects;
- эффекты беспределов и мегабеспределов;
- свойства колдунов;
- фамильяры;
- trophy;
- Dingler;
...
- Реализовать mayhem/mega-mayhem resolution.
- Реализовать combat/death/DWT workflow.
